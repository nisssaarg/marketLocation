...
public class ListPhotosHandler implements HttpHandler {
    ...
    private static final String SELECT_RANDOM_PHOTOS_QUERY = 
        "SELECT M.metadata_id, H.photo_path FROM METADATA M " +
        "JOIN HASH H ON M.hash_id = H.hash_id ORDER BY RANDOM() LIMIT 10"; // Query for 10 random photos
        ...
        if ("GET".equals(exchange.getRequestMethod())) {
            ...
            try (Connection connection = DatabasePool.getConnection();
                ...
                while (resultSet.next()) {
                    ...
                    response.append(metadataId).append(",").append(photoPath).append("\n");
                }
